...
public class Constant {
    ...
    public static final String SEARCH_LOCALE = "Looking for {} locale id";
    public static final String ID_IS = "Id is {}";
    public static final String ADDING_CHARS = "Adding product #{}'s characteristics";
    ...
    public static final String JDBC_ERROR = "Error deregistering driver {}, {}";
}
