...
<div class="sideBar">
    <form action="/Controller" method="post">
        ...
        <button class="adminButton" type="submit" name="admin" value="Orders" ${param.admin == 'Orders' ? 'disabled' : '' }>${orders}</button>
        <button class="adminButton" type="submit" name="admin" value="Products" ${param.admin == 'Products' ? 'disabled' : '' }>${products}</button>
        <button class="adminButton" type="submit" name="admin" value="Users" ${param.admin == 'Users' ? 'disabled' : '' }>${users}</button>
    </form>
</div>

<div class="productArea">
    <c:choose>
        <c:when test="${param.admin == 'Orders'}">
        ...
        <c:when test="${param.admin == 'Products'}">
